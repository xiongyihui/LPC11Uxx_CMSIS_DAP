...
const uint8_t HID_ReportDescriptor[] = {
  ...
  HID_Collection(HID_Application),
    ...
    HID_ReportSize(8),
		HID_Usage(0x01),
    HID_Input(HID_Data | HID_Variable | HID_Absolute | HID_NoWrap | HID_Linear | HID_PreferredState | HID_NoNullPosition),
    HID_ReportCount(64),
    HID_Usage(0x01),
    HID_Output(HID_Data | HID_Variable | HID_Absolute | HID_NoWrap | HID_Linear | HID_PreferredState | HID_NoNullPosition),
  HID_EndCollection,
};
...
const uint8_t USB_DeviceDescriptor[] = {
  ...
  WBVAL(0x2886),                     /* idVendor */
  WBVAL(0x0101),                     /* idProduct */
...
/* Index 0x01: Manufacturer */
  (5*2 + 2),                        /* bLength (13 Char + Type + lenght) */
  USB_STRING_DESCRIPTOR_TYPE,        /* bDescriptorType */
  'S',0,
  'E',0,
  'E',0,
...
/* Index 0x03: Serial Number */
  (9*2 + 2),                        /* bLength (8 Char + Type + lenght) */
  USB_STRING_DESCRIPTOR_TYPE,        /* bDescriptorType */
  '2',0,
  '0',0,
  '1',0,
